...
' =================================
' MODULE:       fsub_Sapling_Conditions
    ...
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_BeforeUpdate[fsub_Sapling_Conditions])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_AfterDelConfirm[fsub_Sapling_Conditions])"
    End Select
    Resume Exit_Handler
End Sub
...
' Revisions:    ML/GS - unknown  - initial version
'               BLC   - 4/16/2018 - added documentation, error handling
'                                   rename chkConditions_Checked > chkConditionsChecked
' ---------------------------------
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Form_AfterUpdate[fsub_Sapling_Conditions])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - cboCondition_AfterUpdate[fsub_Sapling_Conditions])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - cmd_Sapling_Condition_Delete_Click[fsub_Sapling_Conditions])"
    End Select
    Resume Exit_Handler
End Sub
