...
'               BLC, 5/16/2019  - 1.64 - added fw_ module prefix
' =================================
...
'   AppPhotoTypes global dictionary --> defined in app photo types (Big Rivers AppEnum) [fw_mod_App_Data]
    ...
    Select Case Err.Number
      Case 457  'Duplicate PhotoType -- AppEnum finds more than one w/ same name (improbable)
        MsgBox "A duplicate PhotoType was found." & vbCrLf & vbCrLf & _
            ...
            "Error #" & Err.Number & " - GetPhotoTypes[fw_mod_Db]:" & vbCrLf & _
      ...
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetPhotoTypes[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
    ...
    Select Case Err.Number
      Case 457  'Duplicate Item -- finds more than one w/ same name (improbable)
        MsgBox "A duplicate item was found." & vbCrLf & vbCrLf & _
            ...
            "You can close the query after it runs (save it if you like)." & vbCrLf & vbCrLf & _
            "Please contact your data manager to resolve this issue." & vbCrLf & vbCrLf & _
            "Error #" & Err.Number & " - GetDictionary[fw_mod_Db]:" & vbCrLf & _
      ...
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetDictionary[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - fillList[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Sub
...
' --------------------------------------------------------------------
' ---------------------------------
Public Sub PopulateList(ctrlSource As Control, rs As DAO.Recordset, ctrlDest As Control)
On Error GoTo Err_Handler
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - PopulateList[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - AddListToTable[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - getListLastModifiedDate[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - IsUsedExtraArea[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - PopulateCombobox[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - PopulateTree[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ToggleIsActive[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ToggleSensitive[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetHierarchyLevel[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - SetReportRecordset[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Sub
...
'                " query to run.", vbOKOnly, "Oops!"
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetRecords[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      ...
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - SetRecord[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
'------------------------------------------------------------------------------
'----------------------------------------------
' RETIRED - 7/1/2020 - Removing Unused Cases
'----------------------------------------------
'------------------------------------------------------------------------------
'            Case "Contact"
'                Dim p As New Person
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - UpsertRecord[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Sub
...
'----------------------------------------------
' RETIRED - 7/1/2020 - disable unused data
'----------------------------------------------
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - SetObserverRecorder[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Sub

'----------------------------------------------
' RETIRED - 7/1/2020 - Cols compile issue
'----------------------------------------------
'    ' ---------------------------------
'    ' SUB:          CollapseRows
...
'          Case Else
'            MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
'                "Error encountered (#" & Err.Number & " - CollapseRows[fw_mod_App_Data])"
'        End Select
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetProtocolVersion[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetSOPNum[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetParkID[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetParkState[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetRiverSegments[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetRiverSegmentID[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetSiteID[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetFeatureID[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetSurfaceIDs[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetModSedimentSizeIDs[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetQuadratPositions[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - RunPlotCheck[fw_mod_App_Data form])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - SetPlotCheckResult[fw_mod_App_Data form])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - UpdateNumRecords[fw_mod_App_Data form])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - PrepareSpeciesQuery[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function
...
' =================================
'----------------------------------------------
' RETIRED - 7/1/2020 - Unused commented out
'----------------------------------------------
'' ---------------------------------
...
'      Case Else
'        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
'            "Error encountered (#" & Err.Number & " - UpdateTransect[fw_mod_App_Data])"
'    End Select
'    Resume Exit_Handler
'End Function
...
'      Case Else
'        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
'            "Error encountered (#" & Err.Number & " - UpdateMicrohabitat[fw_mod_App_Data])"
'    End Select
'    Resume Exit_Handler
'End Function
'
...
'      Case Else
'        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
'            "Error encountered (#" & Err.Number & " - UpdateCoverSpecies[fw_mod_App_Data])"
'    End Select
'    Resume Exit_Handler
'End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - FetchAddlData[fw_mod_App_Data])"
    End Select
    Resume Exit_Handler
End Function