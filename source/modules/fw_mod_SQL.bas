...
'               BLC, 5/16/2019 - 1.11 - added fw_ module prefix
' =================================
    ...
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetSQL[fw_mod_Point_Intercept])"
    End Select
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetWhereSql[fw_mod_SQL])"
    End Select
    Resume Exit_Function
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetQuerySQL[fw_mod_SQL])"
    End Select
    Resume Exit_Function
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetSQLTemplates[fw_mod_SQL])"
    End Select
    Resume Exit_Sub
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - SQLencode[fw_mod_SQL])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - SetParam[fw_mod_SQL])"
    End Select
    Resume Exit_Function
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetParam[fw_mod_SQL])"
    End Select
    Resume Exit_Function
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetParamsFromSQL[fw_mod_SQL])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ConcatRelated[fw_mod_SQL])"
    End Select
    Resume Exit_Function
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Coalesce[fw_mod_SQL])"
    End Select
    Resume Exit_Function
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - PrepareWhereClause[fw_mod_SQL])"
    End Select
    Resume Exit_Handler
End Function