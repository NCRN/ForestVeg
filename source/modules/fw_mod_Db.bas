...
'               BLC, 5/16/2019  - 1.29 - added fw_ module prefix
' =================================

' ---------------------------------
' Declarations
' ---------------------------------
'   AppTemplates global dictionary --> defined in std Template [fw_mod_Db]
    ...
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - OpenAllDatabases[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
    ...
    Select Case Err.Number
      Case 3061   ' Bad parameters for the SQL string
        MsgBox "Error #" & Err.Number & ":  SQL syntax error. Please notify the " & _
            ...
            "Error encountered (#" & Err.Number & " - BEUpdates[fw_mod_Db])"
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - BEUpdates[fw_mod_Db])"
    End Select
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - getAccessObjectType[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ClearTable[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - AddField[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - RemoveField[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - MergeRecordsets[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - DbObjectExists[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - TableExists[fw_mod_Db])"
    End Select
    Resume Exit_Handler
...
Err_Handler:
    Select Case Err.Number
        ...
        Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - DbTableExists[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - SysTablesExist[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      ...
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - QueryExists[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - qryExists[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
'      Case Else
'        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
'            "Error encountered (#" & Err.Number & " - IsRecordset[fw_mod_Db])"
'    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - HasRecords[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - SetQueryProperty[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetDescription[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - FieldCount[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - MaxDbFieldCount[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - IsLinked[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - RetrieveTableColumnData[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - FieldTypeName[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - VarTypeName[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
    ...
    Select Case Err.Number
      Case 0
        ...
        MsgBox "The table name (" & tbl & ") provided does not exist or was typed " _
            ...
            "Error: Table Doesn't Exist ( FetchDbTableFieldInfo[fw_mod_Db] )"
        'quit the process! (otherwise additional errors will occur w/in calling subs
        End
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - FetchDbTableFieldInfo[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ListTables[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - CloseObject[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ConvertObjectToPointer[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ConvertPointerToObject[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
    ...
    Select Case Err.Number
      Case 457  'Duplicate Template -- tsys_Db_Templates finds more than one w/ same name
        MsgBox "A duplicate Template was found." & vbCrLf & vbCrLf & _
            ...
            "Error #" & Err.Number & " - GetTemplates[fw_mod_Db]:" & vbCrLf & _
      ...
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetTemplates[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetTemplateIDs[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
    ...
    Select Case Err.Number
      Case 457  'Duplicate Template -- tsys_Db_Templates finds more than one w/ same name
        MsgBox "A duplicate Template was found." & vbCrLf & vbCrLf & _
            ...
            "You can close the query after it runs (save it if you like)." & vbCrLf & vbCrLf & _
            "Please contact your data manager to resolve this issue." & vbCrLf & vbCrLf & _
            "Error #" & Err.Number & " - GetTemplate[fw_mod_Db]:" & vbCrLf & _
            Err.Description, vbExclamation, "Duplicate Db Template Found! [tsys_Db_Templates]"
      ...
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - GetTemplate[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - RefreshTemplates[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      ...
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - VirtualDAORecordset[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - RemoveVirtualDAORecordset[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - CreateVirtualADORecordset[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - AddRecords[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - DeleteRecord[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - Delete_All_Records[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - CreateCleanDb[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - HandleDependentQueries[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - RemoveTemplateQueries[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - RefreshTempTable[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - CombineTableSQL[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - SetColumnOrdinalPosition[fw_mod_Db])"
    End Select
    Resume Exit_Handler
End Sub