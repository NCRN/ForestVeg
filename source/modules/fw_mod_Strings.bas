    ...
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (" & Err.Number & " - Ne[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (" & Err.Number & " - SetTrace[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ReplaceChars[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ReplaceString[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ReplaceMulti[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ReplaceTextBetween[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (" & Err.Number & " - ParseString[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (" & Err.Number & " - TitleCaseNameSplit[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (" & Err.Number & " - UnderscoreNameSplit[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ChangeDelimiter[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (" & Err.Number & " - Capitalize[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (" & Err.Number & " - Wrap[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - InsertSpace[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (" & Err.Number & " - InsertSpaceBeforeCaps[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - PadString[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - InternalTrim[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - RemoveNonNumerics[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
        Select Case Err.Number
          Case Else
            MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
                "Error encountered (#" & Err.Number & " - Truncate[fw_mod_Strings])"
        End Select
        Resume Exit_Handler
    End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - CountInString[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - StringFromCodePoint[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - SplitInt[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - ExtractString[fw_mod_Strings])"
    End Select
    Resume Exit_Handler
End Function