dbMemo "SQL" ="SELECT ot.Tag_ID, ot.Location_ID, ot.Tag, ot.Tag_Status, t.Tag_Status AS New_Tag"
    "_Status, td.Tree_Status, t.Tag_ID, t.Location_ID, t.Tag_Status, td.*, t.*, ot.*\015"
    "\012FROM (OLD_tbl_Tags1 AS ot INNER JOIN tbl_Tags AS t ON t.Tag_ID = ot.Tag_ID) "
    "INNER JOIN tbl_Tree_Data AS td ON td.Tag_ID = t.Tag_ID\015\012WHERE td.Tree_Stat"
    "us LIKE 'Dead*'\015\012AND\015\012ot.Tag_Status <> t.Tag_Status\015\012ORDER BY "
...
Begin
    ...
    End
    Begin
        dbText "Name" ="ot.Azimuth"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="ot.Microplot_Number"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="ot.TSN"
    ...
    End
    Begin
        dbText "Name" ="ot.Tag_Notes"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="ot.Start_Date"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="ot.Updated_Date"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="ot.TaxonCode"
        dbLong "AggregateType" ="-1"
    End
End
