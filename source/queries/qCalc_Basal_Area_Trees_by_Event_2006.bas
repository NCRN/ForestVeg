...
Begin
    ...
    End
    Begin
        dbText "Name" ="Tree_BasalArea_cm2_Sum_2006"
        dbInteger "ColumnWidth" ="2895"
        dbBoolean "ColumnHidden" ="0"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Tree_Stem_Count_2006"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Tree_Count_2006"
        dbLong "AggregateType" ="-1"
    End
End
Begin
