...
Begin
    ...
    End
    Begin
        dbText "Name" ="Tree_Status_10"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Tag_Status_10"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Sample_Year_10"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Crown_Class_10"
        dbLong "AggregateType" ="-1"
    End
End
Begin
