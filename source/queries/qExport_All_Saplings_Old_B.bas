...
Begin OutputColumns
    ...
    Expression ="qCalc_Basal_Area_per_Sapling.StemsDead"
    Expression ="qCalc_Basal_Area_per_Sapling.SumLiveBasalArea_cm2"
    Expression ="qCalc_Basal_Area_per_Sapling.SumDeadBasalArea_cm2"
    Expression ="qCalc_Basal_Area_per_Sapling.Equiv_Live_DBH_cm"
    Expression ="qCalc_Basal_Area_per_Sapling.Equiv_Dead_DBH_cm"
    Alias ="Status"
