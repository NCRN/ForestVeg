...
Begin OutputColumns
    ...
    Alias ="Sapling_Count_2010"
    Expression ="Count(qCalc_Basal_Area_per_Sapling.Sapling_Data_ID)"
    Alias ="Sapling_Stem_Count_2010"
    Expression ="CInt(nz(Sum([Stems])))"
    Alias ="Sapling_BasalArea_cm2_Sum_2010"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="Sapling_BasalArea_cm2_Sum_2010"
        dbInteger "ColumnWidth" ="2895"
        dbBoolean "ColumnHidden" ="0"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Sapling_Stem_Count_2010"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Sapling_Count_2010"
        dbLong "AggregateType" ="-1"
    End
End
Begin
