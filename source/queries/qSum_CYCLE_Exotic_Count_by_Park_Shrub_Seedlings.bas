...
Begin OutputColumns
    ...
    Alias ="Count_of_Shrub_Seedlings"
    Expression ="Count(qActive_Seedling_Data.Quadrat_Seedlings_ID)"
    Alias ="Count_of_Exotic_Shrub_Seedlings"
    Expression ="Sum(Abs([Exotic]))"
    Alias ="Percent_Shrub_Seedlings_Exotic"
    Expression ="Round([Count_of_Exotic_Shrub_Seedlings]*100/[Count_of_Shrub_Seedlings],1)"
End
Begin Joins
    ...
    RightTable ="qFiltered_Events"
    Expression ="qActive_Shrub_Seedling_Data.Event_ID=qFiltered_Events.Event_ID"
    Flag =1
    ...
    Expression ="qActive_Shrub_Seedling_Data.Quadrat_Data_ID=qActive_Seedling_Data.Quadrat_Data_I"
        "D"
    Flag =1
End
Begin Groups
...
Begin
    ...
    End
    Begin
        dbText "Name" ="Count_of_Shrub_Seedlings"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Count_of_Exotic_Shrub_Seedlings"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Percent_Shrub_Seedlings_Exotic"
        dbLong "AggregateType" ="-1"
    End
End
Begin
