...
Begin OutputColumns
    ...
    Alias ="Sapling_Count_2008"
    Expression ="Count(qCalc_Basal_Area_per_Sapling.Sapling_Data_ID)"
    Alias ="Sapling_Stem_Count_2008"
    Expression ="CInt(Nz(Sum([Stems])))"
    Alias ="Sapling_BasalArea_cm2_Sum_2008"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="Sapling_Count_2008"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Sapling_Stem_Count_2008"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Sapling_BasalArea_cm2_Sum_2008"
