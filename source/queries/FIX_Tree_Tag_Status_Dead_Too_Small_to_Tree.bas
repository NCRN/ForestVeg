dbMemo "SQL" ="UPDATE tbl_Tags AS t SET t.Tag_Status = 'Tree'\015\012WHERE t.Tag_ID IN \015\012"
    ...
    "d.Tag_ID = t.Tag_ID)\015\012WHERE \015\012td.Tree_Status = 'Dead - Too Small'\015"
    "\012AND\015\012t.Tag_Status <> 'Tree'\015\012ORDER BY \015\012td.Updated_Date, t"
    "d.Tree_Status);\015\012"
dbMemo "Connect" =""
