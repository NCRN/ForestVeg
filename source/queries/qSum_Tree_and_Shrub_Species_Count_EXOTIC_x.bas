...
Option =0
Begin InputTables
    Name ="qCalc_Active_Tree_Shrub-Species_Count_EXOTIC"
End
Begin OutputColumns
    Expression ="[qCalc_Active_Tree_Shrub-Species_Count_EXOTIC].Habit"
    GroupLevel =2
    Expression ="[qCalc_Active_Tree_Shrub-Species_Count_EXOTIC].Sample_Year"
    GroupLevel =1
    Alias ="CountOfTSN"
    Expression ="Count([qCalc_Active_Tree_Shrub-Species_Count_EXOTIC].TSN)"
End
Begin Groups
    Expression ="[qCalc_Active_Tree_Shrub-Species_Count_EXOTIC].Habit"
    GroupLevel =2
...
Begin
    ...
    End
    Begin
        dbText "Name" ="[qCalc_Active_Tree_Shrub-Species_Count_EXOTIC].Habit"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="[qCalc_Active_Tree_Shrub-Species_Count_EXOTIC].Sample_Year"
        dbLong "AggregateType" ="-1"
    End
End
Begin
