...
Begin OutputColumns
    ...
    Alias ="Trees_with_Pests_in_Plot"
    Expression ="Sum(Nz([PestPresentYN],0))"
    Alias ="Total_Pests_in_Plot"
    Expression ="Sum(Nz([PestCount]))"
    Alias ="Percent_Trees_With_Pests"
    Expression ="Round((100*[Trees_with_Pests_in_Plot])/[Trees_in_Plot],1)"
End
Begin Joins
...
Begin
    Begin
        dbText "Name" ="Trees_in_Plot"
        dbLong "AggregateType" ="-1"
        dbInteger "ColumnWidth" ="1575"
        dbBoolean "ColumnHidden" ="0"
    End
    Begin
        dbText "Name" ="Trees_with_Pests_in_Plot"
        dbLong "AggregateType" ="-1"
        dbInteger "ColumnWidth" ="2595"
        dbBoolean "ColumnHidden" ="0"
    End
    Begin
        dbText "Name" ="Total_Pests_in_Plot"
        dbLong "AggregateType" ="-1"
