...
Begin OutputColumns
    ...
    Alias ="Count_of_Saplings"
    Expression ="Count(qActive_Sapling_Data.Sapling_Data_ID)"
    Alias ="Count_of_Exotic_Saplings"
    Expression ="Sum(Abs([Exotic]))"
    Alias ="Percent_Saplings_Exotic"
    Expression ="Round([Count_of_Exotic_Saplings]*100/[Count_of_Saplings],1)"
End
Begin Joins
    ...
    RightTable ="qActive_Sapling_Data"
    Expression ="qFiltered_Events.Event_ID=qActive_Sapling_Data.Event_ID"
    Flag =1
End
Begin OrderBy
    Expression ="qFiltered_Locations.Admin_Unit_Code"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="Count_of_Saplings"
        dbInteger "ColumnWidth" ="2250"
        dbBoolean "ColumnHidden" ="0"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Count_of_Exotic_Saplings"
        dbInteger "ColumnWidth" ="1650"
        dbBoolean "ColumnHidden" ="0"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Percent_Saplings_Exotic"
