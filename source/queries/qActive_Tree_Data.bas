Operation =1
Option =0
Where ="(((tbl_Tree_Data.Tree_Status)<>\"Dead\" And (tbl_Tree_Data.Tree_Status)<>\"Missi"
    "ng\" And (tbl_Tree_Data.Tree_Status)<>\"Removed from Study\" And (tbl_Tree_Data."
    "Tree_Status)<>\"Downgraded to Non-Sampled\"))"
Begin InputTables
    Name ="tbl_Locations"
    Name ="tbl_Events"
    Name ="tbl_Tree_Data"
