dbMemo "SQL" ="SELECT td.Tree_Data_ID, td.Event_ID, td.Tree_Status, cc.Enum_Description AS Crow"
    "nClass, Count(dbh.DBH) AS Stems\015\012FROM (tbl_Tree_Data AS td INNER JOIN tbl_"
    "Tree_DBH AS dbh ON td.Tree_Data_ID = dbh.Tree_Data_ID) INNER JOIN qEnumCrownClas"
    "s AS cc ON td.Crown_Class = cc.CrownClassCode\015\012GROUP BY td.Tree_Data_ID, t"
    "d.Event_ID, cc.Enum_Description, td.Tree_Status;\015\012"
dbMemo "Connect" =""
