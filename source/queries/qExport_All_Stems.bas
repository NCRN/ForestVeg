dbMemo "SQL" ="SELECT Plot_Name, Unit_Code, Unit_Group, Subunit_Code, Cycle, Panel, Frame, Samp"
    ...
    " qExport_All_Tree_Stems\015\012WHERE Status <> 'Removed from study'\015\012UNION"
    " ALL SELECT Plot_Name, Unit_Code, Unit_Group, Subunit_Code, Cycle, Panel, Frame,"
    " Sample_Year, Date, Tag, TSN, Latin_Name, Status, DBH, Live, Habit, Class\015\012"
    "FROM qExport_All_Sapling_Stems\015\012WHERE Status <> 'Removed from study';\015\012"
dbMemo "Connect" =""
