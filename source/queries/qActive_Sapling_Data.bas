...
Where ="(((tbl_Sapling_Data.Sapling_Status)<>\"Dead\" And (tbl_Sapling_Data.Sapling_Stat"
    "us)<>\"Missing\" And (tbl_Sapling_Data.Sapling_Status)<>\"Removed from Study\" A"
    "nd (tbl_Sapling_Data.Sapling_Status)<>\"Downgraded to Non-Sampled\") AND ((tbl_S"
    "apling_Data.Habit)=\"Tree\"))"
Begin InputTables
    Name ="tbl_Locations"
    Name ="tbl_Events"
