...
Begin
    ...
    End
    Begin
        dbText "Name" ="Tree_Count_2008"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Tree_Stem_Count_2008"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="Tree_BasalArea_cm2_Sum_2008"
